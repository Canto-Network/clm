...
const func: DeployFunction = async function(hre: HardhatRuntimeEnvironment) {
    ...
    //reference previously deployed weth, may not be the one used in deployments folder    
    let weth = await ethers.getContractAt("WETH", WETH_ADDRESS, etherDep)
...
export default func;
func.tags = ["ConfigurePairsUpdate", "Update"];
func.dependencies = ["MarketsUpdate", "OracleUpdate"];